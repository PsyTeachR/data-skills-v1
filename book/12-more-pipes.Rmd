...
opts <- c(
  x = "Women had higher AQ scores than men or nonbinary people",
  answer = "Men and nonbinary people's scores did not differ much and both had higher AQ scores than women",
  x = "Men had higher AQ scores than nonbinary people who had higher scores than women"
)

cat("* Which of the following do you think would be an accurate conclusion to draw from the plot?", longmcq(opts))
```
