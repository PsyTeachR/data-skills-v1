...
* Quiz question: I am going to learn a lot: <select class='solveme' data-answer='["TRUE"]'> <option></option> <option>TRUE</option> <option>FALSE</option></select>


<div class='solution'><button>Hidden Solutions</button>
You found it!
</div>
