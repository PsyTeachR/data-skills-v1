...
* Which Sesame Street character a runner was dressed as: <select class='webex-select'><option value='blank'></option><option value=''>ordinal</option><option value=''>interval</option><option value=''>ratio</option><option value='answer'>categorical</option></select>
* Temperature of a runner dressed in a cookie monster outfit (in degrees Celsius): <select class='webex-select'><option value='blank'></option><option value='answer'>interval</option><option value=''>categorical</option><option value=''>ordinal</option><option value=''>ratio</option></select>
