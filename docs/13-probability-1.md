...
* Which Sesame Street character a runner was dressed as: <select class='webex-select'><option value='blank'></option><option value=''>interval</option><option value='answer'>categorical</option><option value=''>ordinal</option><option value=''>ratio</option></select>
